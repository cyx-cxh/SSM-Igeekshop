...
<%--	<link href="${pageContext.request.contextPath}/css/po">--%>
...
{
	alert(oid);
	location.href="${pageContext.request.contextPath}/orderinfo?oid="+oid;
}
		</script>
</HEAD>
<body>
				...
				<td class="ta_01" align="center" bgColor="#f5fafe">
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<c:forEach items="${orderList }" var="order" varStatus="status">
							...
							<td style="CURSOR: hand; HEIGHT: 22px" align ="cernte;" width="I7%">
								${order.oid }
							</td>
