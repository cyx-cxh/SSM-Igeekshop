	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${pageContext.request.contextPath }/showproduct">首页&nbsp;&nbsp;&gt;</a>
				<a href="${pageContext.request.contextPath}/productList?cid=${product.cid}">${category.cname}&nbsp;&nbsp;&gt;</a>
				<a href="${pageContext.request.contextPath }">${product.pname}</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="${pageContext.request.contextPath }/productList&cid=${cid}">返回商品列表</a>
						</div>
					</div>
				</div>
			</div>
